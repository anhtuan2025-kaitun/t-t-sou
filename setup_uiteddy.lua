if not isfile("teddyhub/save.config") then
    writefile("teddyhub/save.config", '{}')
end
local allsetting = game.HttpService:JSONDecode(readfile("teddyhub/save.config"))
...
function Library:NewWindow(ConfigWindow)
	local ConfigWindow = self:MakeConfig({
		Title = "TUANHELLO Hub [Premium]",
		Description = "By Nguyen Anh Tuan Dep Zai",
	}, ConfigWindow or {})
	...
	DropShadow.ZIndex = 0
	DropShadow.Image = "rbxassetid://" --92310734122830-85995292005925
	...
	LogoHub.Image = "rbxassetid://92310734122830"
	...
	Line_2.BackgroundColor3 = Color3.fromRGB(0, 255, 102)
	...
	function Tab:T(t)
		...
		Choose_2.BackgroundColor3 = Color3.fromRGB(0, 255, 102)
		...
		function TabFunc:AddSection(RealNameSection)
			...
			UIGradient.Color = ColorSequence.new {
				...
				ColorSequenceKeypoint.new(0.52, Color3.fromRGB(60, 255, 0)),
			...
			function SectionFunc:AddToggle(cftoggle)
				...
				function ToggleFunc:Set(Boolean)
                    ...
                    local thuathua = game.HttpService:JSONDecode(readfile("teddyhub/save.config"))
                    thuathua[cftoggle.Title] = Boolean
                    writefile("teddyhub/save.config", game.HttpService:JSONEncode(thuathua))
					self.Value = Boolean
					cftoggle.Callback(Boolean)
				end
                if allsetting[cftoggle.Title] and type(allsetting[cftoggle.Title]) == "boolean" then
                    ToggleFunc.Value = allsetting[cftoggle.Title]
                end
			...
			function SectionFunc:AddDropdown(cfdropdown)
				...
				function DropFunc:Add(v)
					...
					UIGradient_3.Color = ColorSequence.new {
						...
						ColorSequenceKeypoint.new(0.51, Color3.fromRGB(34, 255, 5)),
			...
			function SectionFunc:AddSlider(cfslider)
				...
				SliderDraggable.BackgroundColor3 = Color3.fromRGB(43, 255, 0)
				...
				SliderValue.BackgroundColor3 = Color3.fromRGB(42, 254, 0)
	...
	G2L["2"]["Image"] = [[rbxassetid://92310734122830]];
	G2L["2"]["Size"] = UDim2.new(0, 70, 0, 70);
	...
	Close.MouseButton1Down:Connect(function()
		...
		btnyes["BackgroundColor3"] = Color3.fromRGB(0, 255, 102);
		...
		btnyes["BorderColor3"] = Color3.fromRGB(0, 255, 102);
		btnyes["Text"] = [[Yes]];
		...
		btnno["BorderColor3"] = Color3.fromRGB(255, 0, 0);
		btnno["Text"] = [[No]];
